...
# Função para atualizar a data de devolução de emprestimo
...
#insert_user("Alex", "Macedo", "Cambuci", "alex@gmail.com", "+55 1195248-9082")
...
#update_loan_return_date(1, "2024-04-05")
#exibir_livros()